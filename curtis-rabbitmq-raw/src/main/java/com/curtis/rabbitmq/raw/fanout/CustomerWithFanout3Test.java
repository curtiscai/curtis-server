 ...
 * @reference
 */
public class CustomerWithFanout3Test {

    private static final Logger LOGGER = LoggerFactory.getLogger(CustomerWithFanout3Test.class);
    ...
    public void testConsumeMsg2() {
        ...
        try {
            ...
            String queueName3 = "queue-fanout-test3";
            ...
            channel.basicConsume(queueName3, false, new DefaultConsumer(channel) {
                @Override
